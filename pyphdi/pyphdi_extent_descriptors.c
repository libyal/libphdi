...
PySequenceMethods pyphdi_extent_descriptors_sequence_methods = {
	/* sq_length */
	(lenfunc) pyphdi_extent_descriptors_len,
	/* sq_concat */
	0,
	/* sq_repeat */
	0,
	/* sq_item */
	(ssizeargfunc) pyphdi_extent_descriptors_getitem,
	/* sq_slice */
	0,
	/* sq_ass_item */
	0,
...
PyTypeObject pyphdi_extent_descriptors_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyphdi.extent_descriptors",
	/* tp_basicsize */
	sizeof( pyphdi_extent_descriptors_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyphdi_extent_descriptors_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	0,
	/* tp_as_sequence */
	&pyphdi_extent_descriptors_sequence_methods,
	/* tp_as_mapping */
	0,
	/* tp_hash */
	0,
	...
	/* tp_doc */
	"pyphdi sequence and iterator object of extent descriptors",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_iter */
	(getiterfunc) pyphdi_extent_descriptors_iter,
	/* tp_iternext */
	(iternextfunc) pyphdi_extent_descriptors_iternext,
	/* tp_methods */
	0,
	/* tp_members */
	0,
	...
	0,
	/* tp_init */
	(initproc) pyphdi_extent_descriptors_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
PyObject *pyphdi_extent_descriptors_new(
           ...
           int number_of_items )
{
	pyphdi_extent_descriptors_t *sequence_object = NULL;
	static char *function                        = "pyphdi_extent_descriptors_new";
	...
	sequence_object = PyObject_New(
	                   ...
	                   &pyphdi_extent_descriptors_type_object );
...
{
	static char *function = "pyphdi_extent_descriptors_init";
      ...
      pyphdi_extent_descriptors_t *sequence_object )
{
	...
	static char *function       = "pyphdi_extent_descriptors_free";
...
Py_ssize_t pyphdi_extent_descriptors_len(
            pyphdi_extent_descriptors_t *sequence_object )
{
	static char *function = "pyphdi_extent_descriptors_len";
           ...
           Py_ssize_t item_index )
{
	...
	static char *function              = "pyphdi_extent_descriptors_getitem";
...
PyObject *pyphdi_extent_descriptors_iter(
           pyphdi_extent_descriptors_t *sequence_object )
{
	static char *function = "pyphdi_extent_descriptors_iter";
...
{
	PyObject *extent_descriptor_object = NULL;
	static char *function              = "pyphdi_extent_descriptors_iternext";
