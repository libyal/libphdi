...
PySequenceMethods pyphdi_image_descriptors_sequence_methods = {
	/* sq_length */
	(lenfunc) pyphdi_image_descriptors_len,
	/* sq_concat */
	0,
	/* sq_repeat */
	0,
	/* sq_item */
	(ssizeargfunc) pyphdi_image_descriptors_getitem,
	/* sq_slice */
	0,
	/* sq_ass_item */
	0,
...
PyTypeObject pyphdi_image_descriptors_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyphdi.image_descriptors",
	/* tp_basicsize */
	sizeof( pyphdi_image_descriptors_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyphdi_image_descriptors_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	0,
	/* tp_as_sequence */
	&pyphdi_image_descriptors_sequence_methods,
	/* tp_as_mapping */
	0,
	/* tp_hash */
	0,
	...
	/* tp_doc */
	"pyphdi sequence and iterator object of image descriptors",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_iter */
	(getiterfunc) pyphdi_image_descriptors_iter,
	/* tp_iternext */
	(iternextfunc) pyphdi_image_descriptors_iternext,
	/* tp_methods */
	0,
	/* tp_members */
	0,
	...
	0,
	/* tp_init */
	(initproc) pyphdi_image_descriptors_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
/* Creates a new image descriptors sequence and iterator object
...
PyObject *pyphdi_image_descriptors_new(
           ...
           int number_of_items )
{
	pyphdi_image_descriptors_t *sequence_object = NULL;
	static char *function                       = "pyphdi_image_descriptors_new";
	...
	/* Make sure the image descriptors values are initialized
	 */
...
/* Initializes an image descriptors sequence and iterator object
 * Returns 0 if successful or -1 on error
 */
int pyphdi_image_descriptors_init(
     pyphdi_image_descriptors_t *sequence_object )
{
	static char *function = "pyphdi_image_descriptors_init";
	...
	PyErr_Format(
	 ...
	 "%s: initialize of image descriptors not supported.",
	 function );

	return( -1 );
}

/* Frees an image descriptors sequence object
 */
void pyphdi_image_descriptors_free(
      pyphdi_image_descriptors_t *sequence_object )
{
	struct _typeobject *ob_type = NULL;
	static char *function       = "pyphdi_image_descriptors_free";
...
/* The image descriptors len() function
 */
...
/* The image descriptors getitem() function
 */
           ...
           Py_ssize_t item_index )
{
	...
	static char *function             = "pyphdi_image_descriptors_getitem";
	...
	image_descriptor_object = sequence_object->get_item_by_index(
...
/* The image descriptors iter() function
 */
PyObject *pyphdi_image_descriptors_iter(
           pyphdi_image_descriptors_t *sequence_object )
{
	static char *function = "pyphdi_image_descriptors_iter";
...
/* The image descriptors iternext() function
 */
PyObject *pyphdi_image_descriptors_iternext(
           pyphdi_image_descriptors_t *sequence_object )
{
	PyObject *image_descriptor_object = NULL;
	static char *function             = "pyphdi_image_descriptors_iternext";
