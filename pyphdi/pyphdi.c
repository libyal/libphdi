 ...
 */
PyMethodDef pyphdi_module_methods[] = {
	{ "get_version",
	  (PyCFunction) pyphdi_get_version,
	  METH_NOARGS,
	  "get_version() -> String\n"
	  "\n"
	...
	{ "check_file_signature",
	  (PyCFunction) pyphdi_check_file_signature,
...
/* Retrieves the pyphdi/libphdi version
 * Returns a Python object if successful or NULL on error
 */
PyObject *pyphdi_get_version(
 ...
 */
PyModuleDef pyphdi_module_definition = {
	PyModuleDef_HEAD_INIT,

	/* m_name */
	"pyphdi",
	/* m_doc */
	"Python libphdi module (pyphdi).",
	/* m_size */
	-1,
	/* m_methods */
	pyphdi_module_methods,
	/* m_reload */
	NULL,
	/* m_traverse */
	NULL,
...
/* Initializes the pyphdi module
 */
#if PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC PyInit_pyphdi(
                void )
#else
PyMODINIT_FUNC initpyphdi(
                void )
#endif
{
