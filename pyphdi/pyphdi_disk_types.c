...
PyTypeObject pyphdi_disk_types_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyphdi.disk_types",
	/* tp_basicsize */
	sizeof( pyphdi_disk_types_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyphdi_disk_types_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	Py_TPFLAGS_DEFAULT,
	/* tp_doc */
	"pyphdi disk types object (wraps LIBPHDI_DISK_TYPES)",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_init */
	(initproc) pyphdi_disk_types_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
#if PY_MAJOR_VERSION >= 3
	value_object = PyLong_FromLong(
	                LIBPHDI_DISK_TYPE_DIFFERENTIAL );
#else
	value_object = PyInt_FromLong(
	                LIBPHDI_DISK_TYPE_DIFFERENTIAL );
#endif
...
PyObject *pyphdi_disk_types_new(
           void )
{
	pyphdi_disk_types_t *pyphdi_disk_types = NULL;
	static char *function                  = "pyphdi_disk_types_new";

	pyphdi_disk_types = PyObject_New(
	                     struct pyphdi_disk_types,
	                     &pyphdi_disk_types_type_object );

	if( pyphdi_disk_types == NULL )
	{
		PyErr_Format(
		 PyExc_MemoryError,
	...
	return( (PyObject *) pyphdi_disk_types );

on_error:
	if( pyphdi_disk_types != NULL )
	{
		Py_DecRef(
		 (PyObject *) pyphdi_disk_types );
	}
	return( NULL );
}
...
{
	static char *function = "pyphdi_disk_types_init";
      ...
      pyphdi_disk_types_t *pyphdi_disk_types )
{
	...
	static char *function       = "pyphdi_disk_types_free";
