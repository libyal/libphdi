...
#if !defined( _LIBPHDI_LIBCTHREADS_H )
#define _LIBPHDI_LIBCTHREADS_H

#include <common.h>

#if defined( HAVE_MULTI_THREAD_SUPPORT ) && !defined( HAVE_LOCAL_LIBPHDI )
#define HAVE_LIBPHDI_MULTI_THREAD_SUPPORT
#endif
...
#endif /* defined( HAVE_LIBPHDI_MULTI_THREAD_SUPPORT ) */
