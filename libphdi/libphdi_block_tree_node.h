...
#if !defined( _LIBPHDI_BLOCK_TREE_NODE_H )
#define _LIBPHDI_BLOCK_TREE_NODE_H
...
typedef struct libphdi_block_tree_node libphdi_block_tree_node_t;

struct libphdi_block_tree_node
{
...
#endif /* !defined( _LIBPHDI_BLOCK_TREE_NODE_H ) */
