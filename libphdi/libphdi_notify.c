...
{
	static char *function = "libphdi_notify_set_stream";
...
int libphdi_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libphdi_notify_stream_open";
...
int libphdi_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libphdi_notify_stream_close";
