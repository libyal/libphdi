...
int libphdi_extent_table_get_data_files_path_size(
     ...
     libcerror_error_t **error )
{
	static char *function = "libphdi_extent_table_get_data_files_path_size";
...
int libphdi_extent_table_get_data_files_path(
     ...
     libcerror_error_t **error )
{
	static char *function   = "libphdi_extent_table_get_data_files_path";
...
int libphdi_extent_table_set_data_files_path(
     ...
     libcerror_error_t **error )
{
	static char *function = "libphdi_extent_table_set_data_files_path";
...
int libphdi_extent_table_get_data_files_path_size_wide(
     ...
     libcerror_error_t **error )
{
	static char *function = "libphdi_extent_table_get_data_files_path_size_wide";
...
int libphdi_extent_table_get_data_files_path_wide(
     ...
     libcerror_error_t **error )
{
	static char *function = "libphdi_extent_table_get_data_files_path_wide";
...
int libphdi_extent_table_set_data_files_path_wide(
     ...
     libcerror_error_t **error )
{
	static char *function = "libphdi_extent_table_set_data_files_path_wide";
     ...
     libcerror_error_t **error )
{
	...
	static char *function            = "libphdi_extent_table_get_extent_data_file_path";
	...
	if( libphdi_extent_table_join_extent_data_file_path(
	     extent_table,
	     extent_data_filename,
...
int libphdi_extent_table_join_extent_data_file_path(
     ...
     libcerror_error_t **error )
{
	static char *function              = "libphdi_extent_table_join_extent_data_file_path";
	...
	else
	{
		...
		if( libphdi_extent_table_get_data_files_path_size(
		     extent_table,
		...
		if( libphdi_extent_table_get_data_files_path(
		     extent_table,
     ...
     libcerror_error_t **error )
{
	...
	static char *function            = "libphdi_extent_table_get_extent_data_file_path_wide";
	size_t extent_data_filename_size = 0;
	size_t utf8_filename_size        = 0;
...
#error Unsupported size of wchar_t
	...
	if( libphdi_extent_table_join_extent_data_file_path_wide(
	     extent_table,
	     extent_data_filename,
	     extent_data_filename_size,
	     path,
     ...
     libcerror_error_t **error )
{
	...
	static char *function            = "libphdi_extent_table_join_extent_data_file_path_wide";
	size_t safe_path_size            = 0;
	...
	{
#if !defined( HAVE_WIDE_SYSTEM_CHARACTER )
		if( libphdi_extent_table_get_data_files_path_size_wide(
		     extent_table,
		...
		if( libphdi_extent_table_get_data_files_path_wide(
		     extent_table,
...
int libphdi_extent_table_set_extent_storage_media_size_by_index(
     ...
     libcerror_error_t **error )
{
	static char *function = "libphdi_extent_table_set_extent_storage_media_size_by_index";
