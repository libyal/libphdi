...
#if !defined( _LIBPHDI_INTERNAL_CODEPAGE_H )
#define _LIBPHDI_INTERNAL_CODEPAGE_H
 ...
 * The definitions in <libphdi/codepage.h> are copied here
...
#endif /* !defined( _LIBPHDI_INTERNAL_CODEPAGE_H ) */
