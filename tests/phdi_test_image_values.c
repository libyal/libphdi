/*
 * Library image_values type test program
 *
...
/* Tests the libphdi_image_values_initialize function
 * Returns 1 if successful or 0 if not
 */
int phdi_test_image_values_initialize(
     void )
{
	...
	image_values = (libphdi_image_values_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libphdi_image_values_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libphdi_image_values_initialize with memset failing
		 */
...
/* Tests the libphdi_image_values_free function
 * Returns 1 if successful or 0 if not
 */
int phdi_test_image_values_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
/* Tests the libphdi_image_values_get_utf8_filename_size function
 * Returns 1 if successful or 0 if not
 */
int phdi_test_image_values_get_utf8_filename_size(
...
/* Tests the libphdi_image_values_get_utf8_filename function
 * Returns 1 if successful or 0 if not
 */
int phdi_test_image_values_get_utf8_filename(
     libphdi_image_values_t *image_values )
{
...
/* Tests the libphdi_image_values_get_utf16_filename_size function
 * Returns 1 if successful or 0 if not
 */
int phdi_test_image_values_get_utf16_filename_size(
     libphdi_image_values_t *image_values )
{
	libcerror_error_t *error   = NULL;
...
/* Tests the libphdi_image_values_get_utf16_filename function
 * Returns 1 if successful or 0 if not
 */
int phdi_test_image_values_get_utf16_filename(
     libphdi_image_values_t *image_values )
{
...
#endif
{
	...
	PHDI_TEST_RUN(
	 "libphdi_image_values_initialize",
	...
	/* TODO add tests for libphdi_image_values_set_filename */

#if !defined( __BORLANDC__ ) || ( __BORLANDC__ >= 0x0560 )

	/* Initialize image_values for tests
	 */
	result = libphdi_image_values_initialize(
	          &image_values,
	          &error );
	...
	PHDI_TEST_RUN_WITH_ARGS(
	 "libphdi_image_values_get_utf8_filename",
	 phdi_test_image_values_get_utf8_filename,
	 image_values );

	PHDI_TEST_RUN_WITH_ARGS(
	 "libphdi_image_values_get_utf16_filename_size",
	 phdi_test_image_values_get_utf16_filename_size,
	 image_values );

	PHDI_TEST_RUN_WITH_ARGS(
	 "libphdi_image_values_get_utf16_filename",
	 phdi_test_image_values_get_utf16_filename,
	 image_values );
