...
class HandleTypeTests(unittest.TestCase):
  ...
  def test_read_buffer(self):
    ...
    file_size = phdi_handle.get_size()
  ...
  def test_read_buffer_at_offset(self):
    ...
    # Test read beyond file size.
    if file_size > 16:
      data = phdi_handle.read_buffer_at_offset(4096, file_size - 16)
  ...
  def test_seek_offset(self):
    ...
    # TODO: change IOError into ValueError
    with self.assertRaises(IOError):
      phdi_handle.seek_offset(-32 - file_size, os.SEEK_CUR)

    # TODO: change IOError into ValueError
    with self.assertRaises(IOError):
      phdi_handle.seek_offset(-32 - file_size, os.SEEK_END)
