...
#if !defined( _PHDI_TEST_GETOPT_H )
#define _PHDI_TEST_GETOPT_H
...
#define phdi_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t phdi_test_getopt(
                  int argument_count,
...
#endif /* !defined( _PHDI_TEST_GETOPT_H ) */
