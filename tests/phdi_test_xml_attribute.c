...
#include "../libphdi/libphdi_xml_attribute.h"

#if defined( __GNUC__ ) && !defined( LIBPHDI_DLL_IMPORT )

/* Tests the libphdi_xml_attribute_free function
 * Returns 1 if successful or 0 if not
 */
int phdi_test_xml_attribute_free(
     void )
{
	...
	/* Test error cases
	 */
	result = libphdi_xml_attribute_free(
	          NULL,
	          &error );
...
#endif
{
	...
	/* TODO: add tests for libphdi_xml_attribute_initialize */

	PHDI_TEST_RUN(
	 "libphdi_xml_attribute_free",
	 phdi_test_xml_attribute_free );
