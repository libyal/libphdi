...
PHDI_TEST_READ="phdi_test_read";

if ! test -x ${PHDI_TEST_READ};
then
	PHDI_TEST_READ="phdi_test_read.exe";
fi

if ! test -x ${PHDI_TEST_READ};
then
	echo "Missing executable: ${PHDI_TEST_READ}";
