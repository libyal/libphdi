...
LIBRARY_TESTS="block_descriptor block_tree block_tree_node disk_descriptor_xml_file disk_parameters error extent_descriptor extent_table extent_values image_descriptor image_values io_handle notify snapshot_values system_string xml_tag";
...
run_test()
{
	...
	local TEST_EXECUTABLE="./phdi_test_${TEST_NAME}";
...
run_test_with_input()
{
	...
	local TEST_PROFILE_DIRECTORY=$(get_test_profile_directory "input" "libphdi");
