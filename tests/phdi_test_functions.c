...
{
	static char *function     = "phdi_test_get_narrow_source";
...
int phdi_test_get_wide_source(
     ...
     libcerror_error_t **error )
{
	static char *function   = "phdi_test_get_wide_source";
...
int phdi_test_open_file_io_handle(
     ...
     libcerror_error_t **error )
{
	static char *function = "phdi_test_open_file_io_handle";
...
int phdi_test_close_file_io_handle(
     ...
     libcerror_error_t **error )
{
	static char *function = "phdi_test_close_file_io_handle";
	int result            = 0;
