...
{ 
	...
	${TEST_RUNNER} ./${PHDI_TEST_OPEN_CLOSE} ${INPUT_FILE};
...
PHDI_TEST_OPEN_CLOSE="phdi_test_open_close";

if ! test -x ${PHDI_TEST_OPEN_CLOSE};
then
	PHDI_TEST_OPEN_CLOSE="phdi_test_open_close.exe";
fi

if ! test -x ${PHDI_TEST_OPEN_CLOSE};
then
	echo "Missing executable: ${PHDI_TEST_OPEN_CLOSE}";
