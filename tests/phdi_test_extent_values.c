...
/* Tests the libphdi_extent_values_get_type function
 * Returns 1 if successful or 0 if not
 */
int phdi_test_extent_values_get_type(
     libphdi_extent_values_t *extent_values )
{
	...
	/* Test regular cases
	 */
	result = libphdi_extent_values_get_type(
	          extent_values,
	          &type,
	          &error );
...
/* Tests the libphdi_extent_values_get_utf8_filename_size function
 * Returns 1 if successful or 0 if not
 */
int phdi_test_extent_values_get_utf8_filename_size(
     libphdi_extent_values_t *extent_values )
{
	libcerror_error_t *error  = NULL;
	...
	/* Test regular cases
	 */
	result = libphdi_extent_values_get_utf8_filename_size(
	          extent_values,
	          &utf8_filename_size,
	          &error );
...
/* Tests the libphdi_extent_values_get_utf8_filename function
 * Returns 1 if successful or 0 if not
 */
int phdi_test_extent_values_get_utf8_filename(
     libphdi_extent_values_t *extent_values )
{
	...
	/* Test regular cases
	 */
	result = libphdi_extent_values_get_utf8_filename(
	          extent_values,
	          utf8_filename,
	          512,
	          &error );
...
/* Tests the libphdi_extent_values_get_utf16_filename_size function
 * Returns 1 if successful or 0 if not
 */
int phdi_test_extent_values_get_utf16_filename_size(
     libphdi_extent_values_t *extent_values )
{
	libcerror_error_t *error   = NULL;
	...
	/* Test regular cases
	 */
	result = libphdi_extent_values_get_utf16_filename_size(
	          extent_values,
	          &utf16_filename_size,
	          &error );
...
/* Tests the libphdi_extent_values_get_utf16_filename function
 * Returns 1 if successful or 0 if not
 */
int phdi_test_extent_values_get_utf16_filename(
     libphdi_extent_values_t *extent_values )
{
	...
	/* Test regular cases
	 */
	result = libphdi_extent_values_get_utf16_filename(
	          extent_values,
	          utf16_filename,
	          512,
	          &error );
...
#endif
{
	...
	/* TODO add tests for libphdi_extent_values_set */
	...
	PHDI_TEST_RUN_WITH_ARGS(
	 "libphdi_extent_values_get_type",
	 phdi_test_extent_values_get_type,
	 extent_values );
	...
	PHDI_TEST_RUN_WITH_ARGS(
	 "libphdi_extent_values_get_utf8_filename_size",
	 phdi_test_extent_values_get_utf8_filename_size,
	 extent_values );

	PHDI_TEST_RUN_WITH_ARGS(
	 "libphdi_extent_values_get_utf8_filename",
	 phdi_test_extent_values_get_utf8_filename,
	 extent_values );

	PHDI_TEST_RUN_WITH_ARGS(
	 "libphdi_extent_values_get_utf16_filename_size",
	 phdi_test_extent_values_get_utf16_filename_size,
	 extent_values );

	PHDI_TEST_RUN_WITH_ARGS(
	 "libphdi_extent_values_get_utf16_filename",
	 phdi_test_extent_values_get_utf16_filename,
	 extent_values );
