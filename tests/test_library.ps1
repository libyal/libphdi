...
$LibraryTests = "block_descriptor block_tree block_tree_node disk_descriptor_xml_file disk_parameters error extent_descriptor extent_table extent_values image_descriptor image_values io_handle notify snapshot_values system_string xml_tag"
...
Function RunTest
{
	...
	$TestExecutable = "${TestExecutablesDirectory}\phdi_test_${TestName}.exe"
...
Function RunTestWithInput
{
	...
	$TestProfileDirectory = "input\.libphdi"
