...
NTSTATUS __stdcall mount_dokan_ZwCreateFile(
                    const wchar_t *path,
                    DOKAN_IO_SECURITY_CONTEXT *security_context PHDITOOLS_ATTRIBUTE_UNUSED,
                    ACCESS_MASK desired_access,
                    ULONG file_attributes PHDITOOLS_ATTRIBUTE_UNUSED,
                    ULONG share_access PHDITOOLS_ATTRIBUTE_UNUSED,
                    ULONG creation_disposition,
                    ULONG creation_options PHDITOOLS_ATTRIBUTE_UNUSED,
                    DOKAN_FILE_INFO *file_info )
{
	libcerror_error_t *error = NULL;
	...
	PHDITOOLS_UNREFERENCED_PARAMETER( security_context )
	PHDITOOLS_UNREFERENCED_PARAMETER( file_attributes )
	PHDITOOLS_UNREFERENCED_PARAMETER( share_access )
	PHDITOOLS_UNREFERENCED_PARAMETER( creation_options )
