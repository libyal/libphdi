...
void (*phditools_signal_signal_handler)( phditools_signal_t ) = NULL;
...
{
	static char *function = "phditools_signal_handler";
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( phditools_signal_signal_handler != NULL )
			{
				phditools_signal_signal_handler(
				 signal );
			}
			return( TRUE );
...
{
	static char *function = "phditools_signal_attach";
	...
	phditools_signal_signal_handler = signal_handler;

	if( SetConsoleCtrlHandler(
	     (PHANDLER_ROUTINE) phditools_signal_handler,
	     TRUE ) == 0 )
	{
		libcerror_error_set(
		 error,
...
#if defined( _MSC_VER )
	phditools_signal_initialize_memory_debug();
#endif
...
int phditools_signal_detach(
     libcerror_error_t **error )
{
	static char *function = "phditools_signal_detach";
	...
	phditools_signal_signal_handler = NULL;
