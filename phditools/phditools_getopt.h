...
#if !defined( _PHDITOOLS_GETOPT_H )
#define _PHDITOOLS_GETOPT_H
...
typedef struct phditools_option phditools_option_t;

struct phditools_option
{
...
#define phditools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t phditools_getopt(
                  int argument_count,
...
void phditools_getopt_wrapped_fprint(
      FILE *stream,
...
void phditools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const phditools_option_t *options,
      int number_of_options );

int phditools_getopt_get_options_string(
     const phditools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _PHDITOOLS_GETOPT_H ) */
